...
impl CPU {
    ...
    pub fn push_byte<B: Bus>(&mut self, cycles: &mut u32, byte: Byte, bus: &mut B) {
        bus.write(self.stack_addr(), byte);
        *cycles -= 1;
        self.sp = self.sp.wrapping_sub(1);
        *cycles -= 1;
    }
    pub fn push_word<B: Bus>(&mut self, cycles: &mut u32, word: Word, bus: &mut B) {
    ...
    pub fn pull_byte<B: Bus>(&mut self, cycles: &mut u32, bus: &mut B) -> Byte {
    ...
    pub fn pull_word<B: Bus>(&mut self, cycles: &mut u32, bus: &mut B) -> Word {
